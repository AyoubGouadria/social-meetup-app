  ...
  useEffect(() => {
    const fetchEvent = async () => {
      ...
      try {
        ...
        const standardCategories = ["coffee", "walk", "study", "gym", "explore"];
        const isStandardCategory = standardCategories.includes(event.category);
        
        setEventData({
          title: event.title,
          description: event.description,
          category: isStandardCategory ? event.category : "other",
          customCategory: isStandardCategory ? "" : event.category,
