...
import { mockEvents, mockJoinRequests, mockUsers } from "../utils/mockData";
...
export default function MyEvents() {
  ...
  // Mock: Events created by current user (user id "1")
  const myCreatedEvents = mockEvents.filter((e) => e.host.id === "1");

  // Mock: Pending requests for my events
